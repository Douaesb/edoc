            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord" >
                        <a href="index.php" class="non-style-link-menu "><div><p class="menu-text">Tableu de bord</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard"  style="font-size: 15px;">
                                                Voir les informations personnelles de votre compte                                                </div>
                                        </div>
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard"  style="font-size: 15px;">
                                                 Vous allez supprimer définitivement votre compte
                                                </div>
                                        </div>
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            ID médecin : '.$id.' (Genere automatiquement)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        ...
                                        <td class="label-td" colspan="2">
                                            <label for="cpassword" class="form-label">Mot de passe conforme : </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Mot de passe conforme :" required><br>
                                        </td>
                                    </tr>
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a class="close" href="settings.php">&times;</a>
                            <div class="content">
                            Si vous changez également e-mail, veuillez vous déconnecter et vous reconnecter avec votre nouvel e-mail
