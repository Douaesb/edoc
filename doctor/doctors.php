            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="doctors.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Docteurs</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        if($action=='drop'){
            ...
            ';
                ...
                $errorlist= array(
                    ...
                    '2'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Erreur de conformation du mot de passe ! Reconformer le mot de passe</label>',
