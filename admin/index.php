                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    Rendez-vous à venir  <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                    Voici un accès rapide aux rendez-vous à venir <br>
                                ...
                                <td>
                                    ...
                                    Voici un accès rapide aux session à venir <br>
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Voir tous les rendez-vous</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="schedule.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Voir toutes les sessions</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
