            ...
            <table class="menu-container" border="0">
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    <p class="profile-title">Secrétaire</p>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-schedule">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Calendrier</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-settings">
                        <a href="indexchat.php" class="non-style-link-menu"><div><p class="menu-text">Contacter le patient</p></a></div>
                    </td>
                </tr>
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Rechercher le nom ou l'e-mail du médecin" list="doctors">&nbsp;&nbsp;
...
?>
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Ajouter un nouveau docteur</p>
                    </td>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Tous les Docteurs (<?php echo $list11->num_rows; ?>)</p>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Nous navons trouvé aucun élément lié à vos mots clés !</p>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Afficher tous les details.</p><br><br>
                                </td>
                            </tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Ajouter un nouveau docteur.</p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nic" class="input-text" placeholder="Numéro de CIN" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Choisissez des spécialités : </label>
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="password" name="cpassword" class="input-text" placeholder="Conformez le mot de passe" required><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    Ajouter" class="login-btn btn-primary btn">
                                </td>
        ...
        ';
            ...
            $error_1=$_GET["error"];
                $errorlist= array(
                    ...
                    '2'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Erreur de conformation du mot de passe ! Reconformez le mot de passe.</label>',
                    '3'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;"></label>',
                    '4'=>"",
                    '0'=>'',
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nic" class="input-text" placeholder="Numéro de CIN" value="'.$nic.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        ...
                                        <td class="label-td" colspan="2">
                                            <label for="cpassword" class="form-label"> conformez le Mot de passe : </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
