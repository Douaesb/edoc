            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $doctorrow = $database->query("select  * from  docteur;");
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Vous voulez prendre un rendez-vous chez votre Docteur? Vous etes au parfait endroit.<br>                                
                            <p> Suivre l'historique des rendez-vous passés,
                             Renseignez-vous a 
                            <a href="schedule.php" class="non-style-link"><b>"Mes reservations"</b></a> 
<!-- <a href="schedule.php" class="non-style-link"><b>"Séances"</b> </a><br> -->
<!-- <br>Renseignez-vous également sur l'heure d'arrivée prévue de votre médecin ..<br><br> -->
                            </p>
                            
                            <h3>La santé c'est comme la richesse, il ne suffit pas de l'avoir,<br>
                            Il faut savoir la conserver. 
                                </h3>
                                   
        
                            <form action="add-rdv.php" method="post" style="display: flex">                                                                                          
                               <input type="Submit" value="Prendre un rendez-vous" class="login-btn btn-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                                ...
                                <td>
                                    ...
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain = "SELECT *
                                            FROM patient
                                            JOIN rendezvous ON patient.pid = rendezvous.pid
                                            JOIN docteur ON rendezvous.docid = docteur.docid
                                            WHERE patient.pid = $userid
                                            AND rendezvous.daterdv >= '$today'
                                            ORDER BY rendezvous.daterdv ASC";                                                //echo $sqlmain;
